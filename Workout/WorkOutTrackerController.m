...
@interface WorkOutTrackerController ()

@end

@implementation WorkOutTrackerController
...
-(void)viewDidAppear:(BOOL)animated{
    ...
    self.navigationController.tabBarController.navigationController.visibleViewController.navigationItem.title=@"WorkOut Tracker";
